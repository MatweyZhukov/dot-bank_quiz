  ...
  },
  {
    ...
    component: (
      <MonoQuestion
        content={
          <>
            Человек в компании, который продвигает продукт или технологию
            <br /> с миссионерским энтузиазмом.
          </>
        }
      />
    ),
  ...
  },
  {
    ...
    component: (
      <MonoQuestion
        content={
          <>
            Практика из Кремниевой долины, которую Google и Apple внедрили
            <br /> в офисах для фокусировки команд.
            <br />
            <br /> Четыре буквы.
          </>
        }
